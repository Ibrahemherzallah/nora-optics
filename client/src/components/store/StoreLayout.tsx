      ...
      <header className="sticky top-0 z-40 border-b border-line bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-xl p-2.5 hover:bg-surface md:hidden" onClick={() => setMobileOpen((v) => !v)} aria-label="القائمة">
      ...
      <footer className="mt-16 bg-charcoal text-charcoal-fg">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/80">نابلس، فلسطين</p>
